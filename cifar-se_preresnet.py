# -*- coding: utf-8 -*-
"""
Created on Tue Oct 29 09:03:54 2019
...
# Architecture
parser.add_argument('--arch', '-a', metavar='ARCH', default='se_preresnet',
                    choices=model_names,
...
parser.add_argument('--save_dir', default='results-se_resnet5/', type=str)
