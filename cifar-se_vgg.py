# -*- coding: utf-8 -*-
"""
Created on Fri Oct 11 20:44:46 2019
...
# Architecture
parser.add_argument('--arch', '-a', metavar='ARCH', default='se_vgg',
                    choices=model_names,
...
parser.add_argument('--save_dir', default='results-se_vgg16/', type=str)
