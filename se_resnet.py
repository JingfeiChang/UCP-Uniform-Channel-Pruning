...
class CifarSEResNet(nn.Module):
    ...
    def __init__(self, depth, dataset='cifar10', cfg=None, reduction=16):
        ...
        self.relu = nn.ReLU(inplace=True)
        self.layer1 = self._make_layer(block, 16, n, cfg=cfg[0:n], stride=1, reduction=reduction)
        self.layer2 = self._make_layer(block, 32, n, cfg=cfg[n:2*n], stride=2, reduction=reduction)
        self.layer3 = self._make_layer(block, 64, n, cfg=cfg[2*n:3*n], stride=2, reduction=reduction)
