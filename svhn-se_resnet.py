...
import models.cifar2 as models
...
parser.add_argument('--schedule', type=int, nargs='+', default=[75, 112],
...
# Architecture
parser.add_argument('--arch', '-a', metavar='ARCH', default='se_resnet',
                    choices=model_names,
...
parser.add_argument('--save_dir', default='svhn-se_resnet50/', type=str)
