# -*- coding: utf-8 -*-
"""
Created on Tue Nov 12 18:17:22 2019
...
parser.add_argument('--epochs', default=246, type=int, metavar='N',
...
parser.add_argument('--schedule', type=int, nargs='+', default=[123, 184],
...
parser.add_argument('--save_dir', default='svhn-vgg16-1/', type=str)
...
# Validate dataset
assert args.dataset == 'svhn',  'Dataset can only be SVHN.'
